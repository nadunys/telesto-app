...
export default class DetailsCard extends Component<Props, State> {
  ...
  async componentDidMount() {
    try {
      const data = (
        await this.locationsService.getObservatoryDetails(this.props.obsId)
      ).data;
        ...
        {this.state && (
          ...
          >
            ...
            <IonCard color="dark" className="odd-card">
              ...
              <IonCardContent className="title">
                {this.state.observatoryData.name}
              </IonCardContent>
            </IonCard>
            ...
            <IonCard color="dark" className="odd-card">
              ...
              <IonCardContent className="title">
                {new Date(this.state.observatoryData.startTime).toString()}
              </IonCardContent>
            </IonCard>
            <IonCard color="dark" className="odd-card">
              <IonCardHeader>End Date</IonCardHeader>
              <IonCardContent className="title">
                {new Date(this.state.observatoryData.endTime).toString()}
              </IonCardContent>
            </IonCard>
            {/* <IonCard color="dark" className="even-card">
